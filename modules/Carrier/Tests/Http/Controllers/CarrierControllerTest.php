...
namespace Modules\Carrier\Tests\Http\Controllers\Tests;
...
class CarrierControllerTest extends TestCase
{
    ...
    public function testItCanCreateResource()
    {
        ...
        ])->post(route('carriers.store'), $values);
    ...
    public function testItCanShowResource()
    {
        ...
        $response = $this->withHeaders([
            'Authorization' => "Bearer {$this->token['superuser']}",
            'Accept' => 'application/json',
        ])->get(route('carriers.show', ['carrier' => $entity->id]));
    ...
    public function testItCanUpdateResource()
    {
        ...
        $response = $this->withHeaders([
            'Authorization' => "Bearer {$this->token['superuser']}",
            'Accept' => 'application/json',
        ])->put(route('carriers.update', ['carrier' => $entity->id]), $values);
    ...
    public function testItCanDestroyResource()
    {
        ...
        $response = $this->withHeaders([
            'Authorization' => "Bearer {$this->token['superuser']}",
            'Accept' => 'application/json',
        ])->delete(route('carriers.destroy', ['carrier' => $entity->id]));
