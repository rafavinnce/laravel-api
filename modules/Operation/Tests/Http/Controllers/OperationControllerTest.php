...
namespace Modules\Operation\Tests\Http\Controllers\Tests;
...
class OperationControllerTest extends TestCase
{
    ...
    public function testItCanCreateResource()
    {
        ...
        ])->post(route('operations.store'), $values);
    ...
    public function testItCanShowResource()
    {
        ...
        $response = $this->withHeaders([
            'Authorization' => "Bearer {$this->token['superuser']}",
            'Accept' => 'application/json',
        ])->get(route('operations.show', ['operation' => $entity->id]));
    ...
    public function testItCanUpdateResource()
    {
        ...
        $values = [
            'name' => 'Name of operation testing',
        ];

        $response = $this->withHeaders([
            'Authorization' => "Bearer {$this->token['superuser']}",
            'Accept' => 'application/json',
        ])->put(route('operations.update', ['operation' => $entity->id]), $values);
    ...
    public function testItCanDestroyResource()
    {
        ...
        $response = $this->withHeaders([
            'Authorization' => "Bearer {$this->token['superuser']}",
            'Accept' => 'application/json',
        ])->delete(route('operations.destroy', ['operation' => $entity->id]));
